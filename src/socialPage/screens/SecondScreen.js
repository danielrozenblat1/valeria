...
const SecondScreenSocial=()=>{
    ...
    <Box title="איכותיות" icon={free} description="העסק יכול להינות מתוכן איכותי, ממוקד, מקצועי ואסתטי. השקעה באיש מקצוע עם ציוד מקצועי יכולה להביא לתוצאות טובות יותר בטווח הארוך ולסייע בצמיחת העסק בצורה יעילה יותר."/>
    <Box title="מקצועיות" icon={classic} description="אנשי מקצוע בתחום הסושיאל מביאים איתם ידע וניסיון רחב בתחום. הם מכירים את הפלטפורמות , את הטרנדים , ואת הטכניקות הכי יעילות לניהול  והגעה לקהלי יעד"/>
    </div>
    </>
}
