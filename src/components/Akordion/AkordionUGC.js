...
export default function BasicAccordion() {
  ...
  return (
    ...
    <div className={styles.title} id="שאלות נפוצות" itemProp="mainEntity" itemScope itemType="https://schema.org/WebPage">שאלות נפוצות</div>
      <DropdownAccordion title="למה שיווק אותנטי למוצר שלי כל כך חשוב היום?" content=" שיווק אותנטי חשוב היום כי הוא בונה אמון וביטחון בין הצרכן למותג, מסייע ביצירת חיבור רגשי עמוק ומסייע למותג לבלוט בשוק תחרותי" />
      <DropdownAccordion title="את עושה UGC רק על מוצרים/מותגים או גם על בתי עסק, בתי מלון...?" content="עבדתי עם הרבה נישות לכן אוכל להעניק שירות UGC מדוייק לכל לקוח אם זה מוצר/בעל עסק/שירות מסויים/ ביגוד או בתי מלון ומסעדות :)" />
